...
class ListMicrosoft extends StatelessWidget {
  final dynamic companydata;
  
  VoidCallback? press;
  ListMicrosoft({Key? key, required this.companydata, this.press}) : super(key: key);
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  Expanded(
                    flex: 2,
                    child: Image.asset(companydata['imgurl'], height: size.height / 17),
                  ),
                  Expanded(
                    flex: 8,
                    child: Padding(
